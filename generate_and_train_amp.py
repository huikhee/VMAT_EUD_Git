...
def setup_training(encoderunet, unetdecoder, resume=0):
    ...
    if resume == 1:
        checkpoint = torch.load('Cross_CP/Cross_VMAT_Artifical_data_1500_01Dec_amp_coll45_checkpoint.pth', 
                              map_location=device)
...
def train_cross(encoderunet, unetdecoder, train_loaders, val_loaders, device, resume=0):
    ...
    for epoch in range(start_epoch, EPOCHS):
        ...
        torch.save(checkpoint, 'Cross_CP/Cross_VMAT_Artifical_data_1500_01Dec_amp_coll45_checkpoint.pth')
...
if __name__ == "__main__":
    ...
    train_cross(encoderunet, unetdecoder, train_loaders, val_loaders, device, resume=1)
