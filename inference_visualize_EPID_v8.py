"""Inference + visualization for the EPID v8 encoder/decoder model.

v8 changes (relative to v7) are primarily in training behavior (e.g., dataset
assignment across ranks). Model architecture and IO are expected to remain
compatible with the v7 inference/visualization flow.
"""
...
from generate_and_train_EPID_v8 import (
    CustomDataset,
    EncoderUNet,
    UNetDecoder,
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Inference + visualization for EPID v8")
    ...
    parser.add_argument("--checkpoint", type=str, default="Cross_CP/EPID_v8_23Dec25_checkpoint.pth")
    ...
    parser.add_argument("--output-dir", type=str, default="viz_outputs_v8", help="Directory for PNGs")
    ...
    for ds_idx, ds in datasets.items():
        ...
        for si in chosen:
            ...
            title = f"EPID v8 | Dataset {ds_idx} | Sample {si}"
            visualize(
                epid_gt,
                epid_img,
                v1_gt,
