"""Inference + visualization for the EPID v3 encoder/decoder model.
...
v3 differs from v2 in training stability/robustness tweaks (loss weighting,
penalty normalization, scalar scaling, patch size, and stronger NCHW handling).
"""
...
from generate_and_train_EPID_v3 import (
    CustomDataset,
    EncoderUNet,
    UNetDecoder,
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Inference + visualization for EPID v3")
    ...
    parser.add_argument("--checkpoint", type=str, default="Cross_CP/EPID_v3_16Dec25_checkpoint.pth")
    ...
    parser.add_argument("--output-dir", type=str, default="viz_outputs_v3", help="Directory for PNGs")
    ...
    for ds_idx, ds in datasets.items():
        ...
        for si in chosen:
            ...
            title = f"EPID v3 | Dataset {ds_idx} | Sample {si}"
            visualize(
                epid_gt,
                epid_img,
                v1_gt,
