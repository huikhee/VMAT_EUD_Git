...
def setup_training(encoderunet, unetdecoder, resume=0):
    ...
    if resume == 1:
        # Load checkpoint
        checkpoint = torch.load('Cross_CP/Cross_VMAT_Artifical_data_1500_01Dec_amp_parallel_coll0_embedded_64_impLoss2_local_checkpoint.pth', 
                              map_location='cpu')
        ...
        for i, train_loader in enumerate(train_loaders):
            ...
            for batch_idx, (v1, v2, scalars, v1_weight, v2_weight, arrays, arrays_p) in enumerate(train_loader):
                ...
                with autocast():
                    ...
                    loss_for = mse_loss(outputs, arrays)
                    ...
                    loss_for_2 = mse_loss(outputs_2, arrays)
